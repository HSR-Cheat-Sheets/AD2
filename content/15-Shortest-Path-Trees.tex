...
\paragraph{SPT}
\begin{center}
    \includegraphics[scale=.3]{15 ShortestPathTrees/spt.png}
\end{center}

\paragraph{Dijkstra-Algorithmus}
\begin{center}
    \includegraphics[scale=.22]{15 ShortestPathTrees/Dijkstra2.png}
    \includegraphics[scale=.22]{15 ShortestPathTrees/Dijkstra.png}
\end{center}
\newpage